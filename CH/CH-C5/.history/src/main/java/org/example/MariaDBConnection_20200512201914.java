	...
	public void createConnection () {
		try {
            ...
            try {
                // operations
                // IF 1 (+) - IF 2 (-)
				String createJobTable = "create table operations (id int not null, `user` int not null, `operationtype` int not null,`amount` DOUBLE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;";
				this.st.executeQuery(createJobTable);
